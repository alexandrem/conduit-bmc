...
const file_gateway_v1_gateway_proto_rawDesc = "" +
	...
	"\fsol_endpoint\x18\x03 \x01(\v2\x17.gateway.v1.SOLEndpointR\vsolEndpoint\x12:\n" +
	...
	"\x04type\x18\x02 \x01(\x0e2\x13.gateway.v1.BMCTypeR\x04type\x12\x1a\n" +
	"\busername\x18\x03 \x01(\tR\busername\x12\x1a\n" +
	"\bpassword\x18\x04 \x01(\tR\bpassword\x12'\n" +
	"\x03tls\x18\x05 \x01(\v2\x15.gateway.v1.TLSConfigR\x03tls\x12\"\n" +
	"\fcapabilities\x18\x06 \x03(\tR\fcapabilities\"\xb9\x01\n" +
	"\vSOLEndpoint\x12'\n" +
	"\x04type\x18\x01 \x01(\x0e2\x13.gateway.v1.SOLTypeR\x04type\x12\x1a\n" +
	"\bendpoint\x18\x02 \x01(\tR\bendpoint\x12\x1a\n" +
	"\busername\x18\x03 \x01(\tR\busername\x12\x1a\n" +
	"\bpassword\x18\x04 \x01(\tR\bpassword\x12-\n" +
	"\x06config\x18\x05 \x01(\v2\x15.gateway.v1.SOLConfigR\x06config\"\xb9\x01\n" +
	"\vVNCEndpoint\x12'\n" +
	"\x04type\x18\x01 \x01(\x0e2\x13.gateway.v1.VNCTypeR\x04type\x12\x1a\n" +
	"\bendpoint\x18\x02 \x01(\tR\bendpoint\x12\x1a\n" +
	"\busername\x18\x03 \x01(\tR\busername\x12\x1a\n" +
	"\bpassword\x18\x04 \x01(\tR\bpassword\x12-\n" +
	"\x06config\x18\x05 \x01(\v2\x15.gateway.v1.VNCConfigR\x06config\"p\n" +
	"\tTLSConfig\x12\x18\n" +
	...
	"\rbmc_endpoints\x18\x03 \x03(\v2#.gateway.v1.BMCEndpointAvailabilityR\fbmcEndpoints\"\x99\x02\n" +
	...
	"\bbmc_type\x18\x04 \x01(\x0e2\x13.gateway.v1.BMCTypeR\abmcType\x12\x1a\n" +
	"\bfeatures\x18\x05 \x03(\tR\bfeatures\x12\x16\n" +
