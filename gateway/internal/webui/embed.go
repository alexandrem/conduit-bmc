...
func init() {
	...
	vncTemplates, err = template.ParseFS(embedFS, "templates/base.html", "templates/vnc.html", "templates/bmc_info_sidebar.html")
	if err != nil {
		panic("Failed to parse VNC templates: " + err.Error())
	}

	// Parse Console templates separately (base.html + console.html)
	consoleTemplates, err = template.ParseFS(embedFS, "templates/base.html", "templates/console.html", "templates/bmc_info_sidebar.html")
	if err != nil {
